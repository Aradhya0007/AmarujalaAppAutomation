...
//location.....
	...
	//types of epaper 
		...
		public void TypeOfPaper() throws InterruptedException {
			...
			for(int i=0;i<size;i++) {
				String epapername=TypesOfEpaper.get(i).getText();
				
				click(TypesOfEpaper.get(i),"the paper "+epapername);
				Thread.sleep(2000);
	...
	public void forwardaction(int count) throws InterruptedException {
		for(int i=0;i<count;i++) {
			...
			click(forwardbtnepaper,"forward btn from page"+i);
			Thread.sleep(2000);
	...
	public void nextlocation() throws InterruptedException {
		 click(locationpaper,"location btn");
