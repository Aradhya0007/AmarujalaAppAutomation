	...
	//Locator......
		...
		//enter email and number conatiner 
			...
			public void  loginwithNumberPassflow() throws InterruptedException {
				...
				EmailLogin.clear();
				PasswordLogin.clear();
				//invalid pass valid num
				EmailLogin.sendKeys("932409239");
				...
				EmailLogin.clear();
				PasswordLogin.clear();
				//Wrong num and correct pass
				EmailLogin.sendKeys("9027827275");
				...
				EmailLogin.clear();
				PasswordLogin.clear();
				//correct num wrong pass
				EmailLogin.sendKeys("9027827274");
